...
case $pilih in
  1) welcome ;;
  2) menu ;;
  3) wget -q https://raw.githubusercontent.com/grdstorexxx1-lgtm/vip-zi/main/install.sh -O /usr/local/bin/zivpn-manager \
     && chmod +x /usr/local/bin/zivpn-manager \
     && /usr/local/bin/zivpn-manager ;;
  4) desain p0t4t0 ;;
  5) menu ;;
  6) wget https://raw.githubusercontent.com/grdstorexxx1-lgtm/vip-zi/main/speedtest -O /usr/bin/speedtest \
