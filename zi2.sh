...
wget https://github.com/grdstorexxx1-lgtm/vip-zi/releases/download/v1.0/udp-zivpn-linux-arm64 -O /usr/local/bin/zivpn
chmod +x /usr/local/bin/zivpn
mkdir /etc/zivpn 
wget https://raw.githubusercontent.com/grdstorexxx1-lgtm/vip-zi/main/config.json -O /etc/zivpn/config.json
